...
object StickerAsset {
    ...
    fun initStickerPager(): MutableList<EmojiTab> {
        ...
        stickerAssetEntities.add(
            EmojiTab(
                "Cheek",
                R.drawable.ic_cate_sticker_cheek,
                lstCkeeks()
            )
        )
        stickerAssetEntities.add(
            EmojiTab(
                "HairBand",
                R.drawable.ic_cate_sticker_hairband,
                lstHairBands()
            )
        )
        stickerAssetEntities.add(
            EmojiTab(
                "Eye",
                R.drawable.ic_cate_sticker_eye,
                lstEyes()
            )
        )
        stickerAssetEntities.add(
            EmojiTab(
                "Giddy",
                R.drawable.ic_cate_sticker_giddy,
                lstGiddy()
            )
        )
        stickerAssetEntities.add(
            EmojiTab(
                "Glass",
                R.drawable.ic_cate_sticker_glasses,
                lstGlasses()
            )
        )
        stickerAssetEntities.add(
            EmojiTab(
                "Tie",
                R.drawable.ic_cate_sticker_tie,
                lstTies()
            )
        )
        stickerAssetEntities.add(
        ...
        stickerAssetEntities.add(
            EmojiTab(
                "Text",
                R.drawable.ic_cate_sticker_text,
                lstTexts()
            )
        )
        stickerAssetEntities.add(
            EmojiTab(
                "Other",
                R.drawable.ic_cate_sticker_other,
                lstOthers()
            )
        )
        stickerAssetEntities.add(
            EmojiTab(
                "Tatoo",
                R.drawable.ic_cate_sticker_tatoo,
                lstTatoos()
            )
        )

        return stickerAssetEntities
    }


    fun lstTatoos(): MutableList<String> {
    ...
    fun lstOthers(): MutableList<String> {
        val arrayList: MutableList<String> = java.util.ArrayList<String>()
    ...
    fun lstTexts(): MutableList<String> {
        val arrayList: MutableList<String> = java.util.ArrayList<String>()
    ...
    fun lstHearts(): MutableList<String> {
        val arrayList: MutableList<String> = java.util.ArrayList<String>()
    ...
    fun lstTies(): MutableList<String> {
        val arrayList: MutableList<String> = java.util.ArrayList<String>()
    ...
    fun lstHairBands(): List<String> {
        val arrayList: MutableList<String> = java.util.ArrayList<String>()
        arrayList.add("sticker/hairband/01.webp")
        arrayList.add("sticker/hairband/02.webp")
        arrayList.add("sticker/hairband/03.webp")
        arrayList.add("sticker/hairband/04.webp")
        arrayList.add("sticker/hairband/05.webp")
        arrayList.add("sticker/hairband/06.webp")
        arrayList.add("sticker/hairband/07.webp")
        arrayList.add("sticker/hairband/08.webp")
        arrayList.add("sticker/hairband/09.webp")
        arrayList.add("sticker/hairband/10.webp")
        arrayList.add("sticker/hairband/11.webp")
        arrayList.add("sticker/hairband/12.webp")
        arrayList.add("sticker/hairband/13.webp")
        arrayList.add("sticker/hairband/14.webp")
        arrayList.add("sticker/hairband/15.webp")
        arrayList.add("sticker/hairband/16.webp")
        arrayList.add("sticker/hairband/17.webp")
        arrayList.add("sticker/hairband/18.webp")
        arrayList.add("sticker/hairband/19.webp")
        arrayList.add("sticker/hairband/20.webp")
        arrayList.add("sticker/hairband/21.webp")
        arrayList.add("sticker/hairband/22.webp")
        arrayList.add("sticker/hairband/23.webp")
        arrayList.add("sticker/hairband/24.webp")
        arrayList.add("sticker/hairband/25.webp")
        arrayList.add("sticker/hairband/26.webp")
        arrayList.add("sticker/hairband/27.webp")
        arrayList.add("sticker/hairband/28.webp")
        arrayList.add("sticker/hairband/29.webp")
        arrayList.add("sticker/hairband/30.webp")
        arrayList.add("sticker/hairband/31.webp")
        arrayList.add("sticker/hairband/32.webp")
        arrayList.add("sticker/hairband/33.webp")
        arrayList.add("sticker/hairband/34.webp")
        arrayList.add("sticker/hairband/35.webp")
        arrayList.add("sticker/hairband/36.webp")
        arrayList.add("sticker/hairband/37.webp")
        arrayList.add("sticker/hairband/38.webp")
        arrayList.add("sticker/hairband/39.webp")
        arrayList.add("sticker/hairband/40.webp")
        return arrayList
    }

    fun lstCkeeks(): List<String> {
        val arrayList: MutableList<String> = java.util.ArrayList<String>()
